...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_thenewharish100_2548;
            let db_auth = result.data.DB_AUTH_thenewharish100_2548;
            let db_coll = result.data.DB_COLL_thenewharish100_2548;
